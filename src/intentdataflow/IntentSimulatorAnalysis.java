 ...
 */
public class IntentSimulatorAnalysis extends FrameDataflowAnalysis<Constant, ConstantFrame> {
    private MethodGen methodGen;

    private ConstantFrameModelingVisitor visitor;

    public IntentSimulatorAnalysis(MethodGen methodGen, DepthFirstSearch dfs) {
        super(dfs);
